const storyQuestions = [
  {
    id: 1,
    question: "갑작스러운 방문자: 어느 날 궁전의 문 앞에 낯선 방문자가 나타나 자신이 중요한 소식을 가지고 있다고 주장합니다. 공주는 어떻게 반응할까요?",
    options: [
      {
  ...
  {
    id: 2,
    question: "낯선 상인의 제안: 여행 중 한 상인이 공주에게 신비로운 물건을 제안합니다. 가격은 높지만, 물건이 진짜라면 큰 가치를 가질 수도 있습니다.",
    options: [
      {
  ...
  {
    id: 3,
    question: "위기의 순간: 왕국이 위협을 받고 있다는 소식을 들은 공주는 어떤 행동을 선택할까요?",
    options: [
      {
  ...
  {
    id: 4,
    question: "백성들의 반란: 불만을 품은 백성들이 반란을 일으켰을 때, 공주는 어떻게 행동할까요?",
    options: [
      {
  ...
  {
    id: 5,
    question: "왕실의 외교적 초대: 이웃 왕국에서 공주를 외교 행사에 초대했습니다. 공주는 어떻게 준비할까요?",
    options: [
      {
  ...
  {
    id: 6,
    question: "궁전의 화재 사건: 어느 날 밤, 궁전의 한쪽에서 화재가 발생했습니다. 공주는 무엇을 우선적으로 해야 할까요?",
    options: [
      {
  ...
  {
    id: 7,
    question: "전쟁 포로의 처리: 전쟁에서 적국의 고위 장군이 포로로 잡혔습니다. 공주는 이 포로를 어떻게 대해야 할까요?",
    options: [
      {
  ...
  {
    id: 8,
    question: "신비로운 숲의 유혹: 공주는 왕국 근처 신비로운 숲에 대한 소문을 듣습니다. 이 숲은 위험하지만, 큰 보물이 숨겨져 있다는 이야기가 있습니다.",
    options: [
      {
  ...
  {
    id: 9,
    question: "전염병의 위기: 왕국에 전염병이 퍼지기 시작했습니다. 공주는 어떻게 대처할까요?",
    options: [
      {
  ...
  {
    id: 10,
    question: "왕가의 유산: 공주는 오래된 왕가의 보물을 발견합니다. 하지만, 그 보물은 무거운 저주를 동반한다고 전해집니다.",
    options: [
      {
